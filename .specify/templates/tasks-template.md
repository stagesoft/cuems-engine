...
**Tests**: Include automated test tasks for every behavior change. If a feature has no
test impact, tasks MUST explicitly justify why.
...
- [ ] T018 [US1] Validate UX consistency for impacted flows/messages
- [ ] T019 [US1] Verify performance budget for critical path
...
- [ ] T026 [US2] Validate UX consistency for impacted flows/messages
- [ ] T027 [US2] Verify performance budget for critical path
...
- [ ] T033 [US3] Validate UX consistency for impacted flows/messages
- [ ] T034 [US3] Verify performance budget for critical path
