...
from .tools.communicate import editor_listener, CommunicatorListener, CominunicatorDialer
...
class ControllerEngine(BaseEngine):
    ...
    def msg_hwdiscovery(self, request):
        ...
        self._hwdiscovery_dialer_task = asyncio.run_coroutine_threadsafe(caller.dial(request), self._loop)
