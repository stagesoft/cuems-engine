...
from .endpoints import OSC_AUDIOPLAYER_CONF as AUDIO_ENDPOINTS, OSC_DMXPLAYER_CONF as DMX_ENDPOINTS, OSC_VIDEOPLAYER_CONF as VIDEO_ENDPOINTS, OSC_ENGINE_CMD_CONF as ENGINE_CMD_ENDPOINTS, OSC_PLAYERS_DICT as PLAYERS_ENDPOINTS_DICT
