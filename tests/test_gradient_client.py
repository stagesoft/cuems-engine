...
class TestSendFade:
    ...
    def test_send_fade_node_uuid_injected_as_node_name(self, udp_listener, gradient_client):
    ...
    def test_send_fade_start_mtc_ms_is_int64(self, udp_listener):
        ...
        assert _type_tag_str(data)[8] == 'h', "start_mtc_ms type tag must be 'h' (int64)"
...
class TestSendCancelMotion:
    def test_send_cancel_motion_emits_correct_address(self, udp_listener, gradient_client):
