...
class TestJackConnectionManager:
    ...
    def mock_jack_client(self):
        ...
        mock_client.get_ports.return_value = [mock_port1, mock_port2, mock_port3, mock_port4]
    ...
    def jack_manager(self, mock_jack_client):
        ...
        with patch('cuemsengine.players.JackConnectionManager.jack.Client') as mock_client_class:
    ...
    def test_jack_connection_manager_initialization(self, mock_jack_client):
        ...
        with patch('cuemsengine.players.JackConnectionManager.jack.Client') as mock_client_class:
            ...
            mock_client_class.assert_called_once_with('test_client', no_start_server=True)
    ...
    def test_client_property_reinitializes_on_none(self, mock_jack_client):
        ...
        with patch('cuemsengine.players.JackConnectionManager.jack.Client') as mock_client_class:
            ...
            assert mock_client_class.call_count == 2  # Called twice: init and property access
    ...
    def test_get_ports_success(self, jack_manager, mock_jack_client):
        ...
        expected_ports = ['system:playback_1', 'system:playback_2', 'system:capture_1', 'test_client:output_1']
    ...
    def test_disconnect_by_name_success(self, jack_manager, mock_jack_client):
        ...
        assert result is True
        mock_jack_client.disconnect.assert_called_once_with('source:output', 'dest:input')
    ...
    def test_is_connected_true(self, jack_manager):
        ...
        with patch.object(jack_manager, 'get_connections', return_value=['dest:input', 'other:port']):
    ...
    def test_is_connected_false(self, jack_manager):
        ...
        with patch.object(jack_manager, 'get_connections', return_value=['other:port1', 'other:port2']):
            result = jack_manager.is_connected('source:output', 'dest:input')
    ...
    def test_integration_workflow(self, mock_jack_client):
        ...
        with patch('cuemsengine.players.JackConnectionManager.jack.Client') as mock_client_class:
            ...
            # Connect two ports
            result = manager.connect_by_name('test_client:output_1', 'system:playback_1')
            assert result is True
            
            # Check if connected
            is_connected = manager.is_connected('test_client:output_1', 'system:playback_1')
            assert is_connected is True
            
            # Disconnect
            result = manager.disconnect_by_name('test_client:output_1', 'system:playback_1')
            assert result is True
