...
from .fixtures import mock_config_path, mock_avahi_resolve, mock_library_path, mock_controller_ip, suppress_logging
...
def test_two_projects_load_from_controller(mock_config_path, mock_avahi_resolve, mock_library_path, mock_controller_ip, suppress_logging, engine_cleanup):
    """Test the project load from the controller"""
    # ARRANGE
    controller_engine = ControllerEngine(with_mtc=False)
    controller_engine.set_oscquery()
